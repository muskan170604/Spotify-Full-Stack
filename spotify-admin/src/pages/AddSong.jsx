...
const AddSong = () => {
    ...
    //ye add song ke Album ke option me bhot sara album ka option ke liye use hua h
...
//execute the upper function whenever its loaded
    useEffect(()=>{
        loadAlbumData();
    },[])
...
return loading?(
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600'>
        ...
        <button type='submit' className='text-base bg-black cursor-pointer text-white py-2.5 px-14 '>ADD</button>
    </form>
)
}
